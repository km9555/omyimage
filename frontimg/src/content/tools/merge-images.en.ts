...
/**
 * English copy for /merge-images. Structure lives in ToolPageShell; the page
...
const content: ToolPageContent = {
  ...
  intro:
    "Combine several photos into a single image in seconds. oMyImage's Merge Images tool joins your pictures side by side, stacked, or in a grid right in your browser, with control over order, spacing and background. Build collages, before-and-afters or comparison sheets and download instantly — nothing is uploaded, so your images stay private.",
  ...
  security:
    "Your images stay private. Merging happens entirely in your browser with HTML canvas — nothing is uploaded to a server. No storage, no tracking of your files.",
