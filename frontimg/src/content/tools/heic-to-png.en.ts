...
/**
 * English copy for /heic-to-png. Structure lives in ToolPageShell; the page
...
const content: ToolPageContent = {
  ...
  locale: "en",
  name: "HEIC to PNG",
  crossLink: { lead: "Want a smaller file instead?", label: "Convert HEIC to JPG", toolId: "heic-to-jpg" },
  category: { id: "convert", label: "Convert" },

  intro:
    "Turn the .heic photos your iPhone produces into PNG files that open on anything. PNG is lossless, so the converted image is exactly what came out of the decoder — no second round of compression on top of what the camera already did. Add one photo or a whole camera roll.",
