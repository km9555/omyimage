...
/**
 * English copy for /upscale-image. Structure lives in ToolPageShell; the page
...
const content: ToolPageContent = {
  ...
  faqs: [
    ...
    { q: "What format do I get back?", a: "The same one you put in — a JPG comes back as a JPG, a PNG as a PNG, a WEBP as a WEBP. JPGs are re-encoded at high quality with full colour resolution, so the file stays a sensible size instead of ballooning into a lossless PNG many times larger. Transparency is preserved for PNG and WEBP." },
