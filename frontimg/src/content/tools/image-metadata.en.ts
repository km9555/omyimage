...
/**
 * English copy for /image-metadata. Structure lives in ToolPageShell; the page
...
const content: ToolPageContent = {
  ...
  intro:
    "See the hidden story behind any photo. oMyImage's Image Metadata Viewer reads the EXIF data embedded in your image right in your browser — camera and lens, aperture, shutter speed, ISO, capture date and even GPS location — and lays it out clearly, with the complete tag list a click away. Nothing is uploaded, so your photo stays private.",
