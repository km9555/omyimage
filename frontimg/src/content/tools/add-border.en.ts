...
/**
 * English copy for /add-border. Structure lives in ToolPageShell; the page
...
const content: ToolPageContent = {
  ...
  security:
    "Your images stay private. Adding borders happens entirely in your browser with HTML canvas — nothing is uploaded to a server. No storage, no tracking of your files.",
