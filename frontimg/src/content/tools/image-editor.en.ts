...
/**
 * English copy for /image-editor. Structure lives in ToolPageShell; the page
...
const content: ToolPageContent = {
  ...
  intro:
    "One editor for everything. oMyImage's All-in-One Image Editor brings crop, resize, rotate and flip, color adjustments and filters, grayscale, blur, borders, circle crop, text and logo watermarks, and freehand drawing together on a single canvas. Apply edits in any order, undo and redo freely, and export once when you're done. It all runs in your browser, so your image stays completely private.",
