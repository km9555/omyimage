...
/**
 * English copy for /blur-image. Structure lives in ToolPageShell; the page
...
const content: ToolPageContent = {
  ...
  security:
    "Your images stay private. Blurring happens entirely in your browser with HTML canvas — nothing is uploaded to a server. No storage, no tracking of your files.",
