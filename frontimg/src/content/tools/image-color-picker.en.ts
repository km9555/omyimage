...
/**
 * English copy for /image-color-picker. Structure lives in ToolPageShell; the page
 * <title> and meta description stay in lib/tools.ts (seoTitle/seoDescription).
 */
const content: ToolPageContent = {
  toolId: "image-color-picker",
  locale: "en",
  name: "Image Color Picker & Color Extractor",
  tagline:
