...
/**
 * "Continue with Google" — redirects the browser to the backend's OAuth
 * initiation endpoint. The backend then redirects to Google and, after consent,
 * back to /auth/callback with a JWT in the query string.
 *
